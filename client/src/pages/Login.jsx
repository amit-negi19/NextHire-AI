...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      toast.success(isRegister ? '🎉 Account created! Welcome to NextHire!' : '✅ Welcome back!');
      navigate('/dashboard');
    } else {
        ...
        <div style={{ width: '100%', maxWidth: 360 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            {isRegister && (
              <div className="form-group">
                ...
                <input
                  ...
                  type="text" name="name" placeholder="Mikey"
            ...
            <div className="form-group">
              ...
              <input
                className="form-input"
                type="email" name="email" placeholder="mikey@example.com"
